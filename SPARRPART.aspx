<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="SPARRPART.aspx.cs" Inherits="CanezPower.SPARRPART" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label ID="LBLESTADO1" runat="server" style="text-align: center; font-size: small; color: #0000FF; font-weight: 700; text-decoration: underline; font-style: italic"></asp:Label>
        ...
        <tr>
            ...
            <td style="text-align: center"><b>
                <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/CATEGORY.aspx">CATEGORY</asp:HyperLink>
                </b></td>
        ...
        <tr>
            <td class="text-center" style="width: 121px">
                <asp:Button ID="BTNSAVE" runat="server" OnClientClick="return confirm('Are you sure you want to save this item?');"  Text ="SAVE AND SEND" OnClick="Button3_Click" Width="91px" CssClass="FixedHeader" />
            </td>
            <td class="text-center">
            ...
            <td class="text-center">
                <asp:Button ID="BTNDELETE" runat="server"  OnClientClick="return confirm('Are you sure you want to delete this item?');" Text="DELETE" OnClick="Button5_Click" Width="91px" CssClass="FixedHeader" />
            </td>
        ...
        <tr>
            ...
            <td colspan="2" style="text-align: center"><b>
                    <asp:Button ID="save0" runat="server" Text="File Upload"   OnClick="save0_Click" Width="142px" />
                </b></td>
            <td><b></b></td>
            <td><b></b></td>
        </tr>
    ...
    <table style="width: 1%; height: 9px;">
        <tr>
            <td class="text-center" style="font-weight: bold; width: 205px; text-align: center;">Search</td>
            <td class="text-center" style="font-weight: bold">&nbsp;</td>
            <td><b></b></td>
            <td><b></b></td>
            <td><b></b></td>
