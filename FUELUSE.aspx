<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="FUELUSE.aspx.cs" Inherits="CanezPower.FUELUSE" %>
    ...
    <asp:Label ID="LBLESTADO1" runat="server"></asp:Label>
        ...
        <tr>
            ...
            <td style="text-align: center"><b>
                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/VEHICLE.aspx">VEHICLE</asp:HyperLink>
                </b></td>
