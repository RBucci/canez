...
{
    public partial class wandy12 : System.Web.UI.Page
    {
        ...
        protected void BTNSAVE_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MOSTRAR();
                Response.Redirect("~/wandy12.aspx");
            }
        ...
        protected void save0_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                for (int i = 0; i < Context.Request.Files.Count; i++)
                {
                    ...
                    string CADENA = string.Format("insert into DOCUMENT_SHOP values('" + id + "','" + GridView1.SelectedRow.Cells[4].Text + "','" + "http://canezpowerdivision.com/canezpdf/" + nombre + "',GETDATE(),'" + GetTime() + "','" + "WANDY" + "')");
                    DataSet DS = CLASS_CONECTAR.CONECTAR(CADENA);
                }
            }
            catch (Exception ERROR)
