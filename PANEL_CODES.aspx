<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="PANEL_CODES.aspx.cs" Inherits="CanezPower.PANEL_CODES" %>
...
document.getElementById(cajadestino).focus(); 
    ...
    <tr>
        ...
        <td style="height: 4px; width: 178px; " class="text-left">
            ...
            <asp:TextBox ID="TXTCODE" runat="server" Width="144px" TabIndex="60" TextMode="Number" Height="26px" style="font-size: xx-small" CssClass="FixedHeader"></asp:TextBox>
