<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CM.aspx.cs" Inherits="CanezPower.CM" %>
  ...
  <%--  <form id="form1" runat="server">--%>
    ...
    <table style="width: 27%; height: 2px;">
                    ...
                    <asp:Button ID="BTNSAVE" runat="server" OnClientClick="return confirm('Are you sure you want to save this item?');"  OnClick="BTNSAVE_Click" Text="SAVE AND SEND" Width="91px" CssClass="auto-style25" />
                        ...
                        <td><span style="color: #000000"><span class="auto-style25">
                    <asp:Button ID="BTNEDIT" runat="server"   Text="EDIT" Width="91px" OnClientClick="return confirm('Are you sure you want to edit this item?');" CssClass="auto-style25" OnClick="BTNEDIT_Click" />
                </span></span></td>
                        <td><span style="color: #000000"><span class="auto-style25">
                    <asp:Button ID="BTNDELETE" runat="server"   Text="DELETE" Width="91px" CssClass="auto-style25" OnClientClick="return confirm('Are you sure you want to delete this item?');"   OnClick="BTNDELETE_Click" />
                </span></span></td>
                    </tr>
                </table>
    ...
    <table style="width: 4%">
                    ...
                    <tr>
                        ...
                        <td>
                            &nbsp;</td>
                        <td>&nbsp;</td>
                        <td class="text-center" style="font-weight: bold; text-align: center;">SINCE</td>
                        <td class="text-center" style="font-weight: bold; text-align: center;">UNTIL</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
