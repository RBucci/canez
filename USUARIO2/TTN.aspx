<%@ Page Title="" Language="C#" MasterPageFile="~/USUARIO2/Site2.Master" AutoEventWireup="true" CodeFile="TTN.aspx.cs" Inherits="CanezPower.USUARIO2.TTN" %>
    ...
    <table style="width: 47%; height: 4px;">
        ...
        <tr>
            <td style="width: 153px">
                &nbsp;</td>
            <td class="text-center">
            <asp:Button ID="BTNGUARDAR1" runat="server" Text="DELETE" Width="91px "  OnClientClick="return confirm('Are you sure you want to delete this item?');"  OnClick="DELETE" style="font-size: xx-small" CssClass="FixedHeader" Visible="False" />
            </td>
            <td class="text-center">
                &nbsp;</td>
        </tr>
