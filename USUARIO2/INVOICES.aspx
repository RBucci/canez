<%@ Page Title="" Language="C#" MasterPageFile="~/USUARIO2/Site2.Master" AutoEventWireup="true" CodeFile="INVOICES.aspx.cs" Inherits="CanezPower.USUARIO2.INVOICES" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        ...
        <td class="right" style="font-weight: bold; width: 178px; color: #000000; text-align: right; height: 31px;">
            <asp:Button ID="BTNGUARDAR" runat="server" Text="SAVE" Width="91px" OnClick="BTNGUARDAR_Click1" style="font-size: xx-small" Height="23px"  />
        </td>
        <td style="width: 154px; height: 31px; text-align: right;">
            <span style="font-size: xx-small"></span>
            <asp:Button ID="TXTEDIT" runat="server" Text="EDIT" Width="91px" OnClick="TXTEDIT_Click" style="font-size: xx-small" Height="23px"  />
        </td>
        <td style="width: 267px; height: 31px;">
            </span>
            <asp:Button ID="TXTDELETE" runat="server" Text="DELETE" Width="91px" OnClick="TXTDELETE_Click" style="font-size: xx-small" Height="23px" Visible="False"  />
        </td>
        <td style="width: 267px; height: 31px;">
            &nbsp;</td>
        <td style="width: 267px; height: 31px;">
