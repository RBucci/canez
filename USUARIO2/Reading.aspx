<%@ Page Title="" Language="C#" MasterPageFile="~/USUARIO2/Site2.Master" AutoEventWireup="true" CodeFile="Reading.aspx.cs" Inherits="CanezPower.USUARIO2.Reading" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 50%; height: 5px;">
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td style="width: 99px">
                <asp:Button ID="Button3" runat="server" OnClick="Button3_Click1" Text="Summary" Width="141px" />
            </td>
            <td style="width: 89px">&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>  
               <%-- <asp:Button ID="BTNSAVE" runat="server" OnClick="BTNSAVE_Click" Text="SAVE" Width="135px" />--%>
                <asp:Button ID="BTNSAVE" runat="server" OnClick="BTNSAVE_Click" Text="Save and Send" Width="141px" Enabled="False" />
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td style="width: 99px">&nbsp;</td>
