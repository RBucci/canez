<%@ Page Title="" Language="C#" MasterPageFile="~/USUARIO2/Site2.Master" AutoEventWireup="true" CodeFile="CATEGORY.aspx.cs" Inherits="CanezPower.USUARIO2.CATEGORY" %>
    ...
    <table style="width: 90%">
        ...
        <tr>
            ...
            <td style="width: 81px; height: 15px;">
                ...
                <asp:Button ID="BTNEXPO" runat="server" Text="SAVE AND SEND" OnClientClick="return confirm('Are you sure you want to save this item?');" OnClick="BTNEXPO_Click" style="font-size: xx-small" Width="91px" />  
