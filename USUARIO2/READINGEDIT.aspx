<%@ Page Title="" Language="C#" MasterPageFile="~/USUARIO2/Site2.Master" AutoEventWireup="true" CodeFile="READINGEDIT.aspx.cs" Inherits="CanezPower.USUARIO2.READINGEDIT" %>
    ...
    <table style="width: 38%">
        ...
        <tr>
            ...
            <td><span style="color: #000000"><span class="auto-style25">
                    <asp:Button ID="BTNSAVE" runat="server" OnClientClick="return confirm('Are you sure you want to save this item?');"   Text="SAVE AND SEND" Width="91px" CssClass="auto-style25" OnClick="BTNSAVE_Click" />
                </span></span></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
