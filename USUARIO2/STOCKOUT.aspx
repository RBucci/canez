<%@ Page Title="" Language="C#" MasterPageFile="~/USUARIO2/Site2.Master" AutoEventWireup="true" CodeFile="STOCKOUT.aspx.cs" Inherits="CanezPower.USUARIO2.STOCKOUT" %>
    ...
    <table style="width: 72%">
        <tr>
            <td>
                ...
                <asp:GridView ID="GridView1" runat="server" Height="16px"  Width="1049px" CellPadding="4" ForeColor="Black" CssClass="auto-style25" style="font-size: x-small; text-align: left;"  Font-Names="Latha" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
