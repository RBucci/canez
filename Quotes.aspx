<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Quotes.aspx.cs" Inherits="CanezPower.Quotes" %>
...
document.getElementById(cajadestino).focus(); 
    ...
    <tr>
        ...
        <td style="width: 267px; height: 31px;">
            ...
            <asp:Button ID="TXTDELETE" runat="server"  OnClientClick="return confirm('Are you sure you want to delete this item?');" Text="DELETE" Width="91px" OnClick="TXTDELETE_Click" style="font-size: xx-small" Height="23px"  />
        </td>
        <td style="width: 267px; height: 31px;">
            &nbsp;</td>
        <td style="width: 267px; height: 31px;">
