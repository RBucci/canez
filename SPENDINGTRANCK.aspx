<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SPENDINGTRANCK.aspx.cs" Inherits="CanezPower.SPENDINGTRANCK" %>
...
document.getElementById(cajadestino).focus(); 
    ...
    <tr>
        ...
        <td style="height: 4px; width: 111px">
                ...
                <asp:HyperLink ID="HyperLink1" runat="server" style="font-size: x-small" NavigateUrl="~/NEW_PROVIDER.aspx" >ADD NEW PROVIDER</asp:HyperLink>
    ...
    <tr>
        ...
        <td style="height: 31px; text-align: right;">
            ...
            <asp:Button ID="TXTEDIT" runat="server" Text="EDIT" Width="91px"  OnClientClick="return confirm('Are you sure you want to edit this item?');"  OnClick="TXTEDIT_Click" style="font-size: xx-small" Height="23px"  />
        </td>
        <td style="width: 111px; height: 31px;">
            </span>
            <asp:Button ID="TXTDELETE" runat="server" Text="DELETE" Width="91px"  OnClientClick="return confirm('Are you sure you want to delete this item?');"   OnClick="TXTDELETE_Click" style="font-size: xx-small" Height="23px"  />
        </td>
