...
{
    public partial class NEW_PLANTA : System.Web.UI.Page
    {
        ...
        void ver_NEW_site_()
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    CBASING.DataBind();
                    CBASING.Items.Insert(0, new ListItem("NA"));
        ...
        protected void BTNGUARDAR_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string COMANDO1 = string.Format("INSERT INTO GENSET_MOVEMENT VALUES (GETDATE(),'" + "NEW STOCK" + "','" + TXTGENSETMODEL.Text + "','" + TXTGENSETSERIAL.Text + "','" + DROPSITE.Text + "','" + TXTNOTE2.Text + "','" + GetTime() + "')");
                DataSet DS1 = CLASS_CONECTAR.CONECTAR(COMANDO1);
