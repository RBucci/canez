<%@ Page Title="" Language="C#" MasterPageFile="~/otheruser/user.Master" AutoEventWireup="true" CodeBehind="AdminAdmin.aspx.cs" Inherits="CanezPower.AdminAdmin" %>
...
document.getElementById(cajadestino).focus(); 
    ...
    <tr>
        ...
        <td class="right" style="font-weight: bold; width: 178px; color: #000000; text-align: right; height: 31px;">
            <asp:Button ID="BTNGUARDAR" runat="server" Text="SAVE AND SEND" OnClientClick="return confirm('Are you sure you want to save this item?');" Visible="false" Width="91px" OnClick="BTNGUARDAR_Click1" style="font-size: xx-small" Enabled="False"  />
        </td>
        <td style="width: 154px; height: 31px; text-align: right;">
            <span style="font-size: xx-small"></span>
            <asp:Button ID="BTNEDIT" runat="server" OnClientClick="return confirm('Are you sure you want to edit this item?');" Visible="false" Text="EDIT" Width="91px" OnClick="TXTEDIT_Click" style="font-size: xx-small" Enabled="False"  />
        </td>
        <td style="width: 267px; height: 31px;">
            </span>
            <asp:Button ID="BTNDELETE" runat="server" Text="DELETE" Width="91px" OnClientClick="return confirm('Are you sure you want to delete this item?');" Visible="false" OnClick="TXTDELETE_Click" style="font-size: xx-small" Enabled="False"  />
        </td>
    </tr>
    <tr>
