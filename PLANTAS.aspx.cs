...
//            A) Pasarlo por la querystring. 
            ...
            Response.Redirect("~/NEW_PLANTA.aspx?MyVar=" + COMANDO.ToString()); 
...
//String myVar = Session["MyVar"].ToString();
        ...
        protected void btnrentail_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/RENTAIL.aspx");
        }

        protected void btnEngineReplacement_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/EngineReplacement.aspx");
        }
