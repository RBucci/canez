<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="INVOICES.aspx.cs" Inherits="CanezPower.INVOICES" %>
...
document.getElementById(cajadestino).focus(); 
    ...
    <table style="width: 47%; height: 185px;">
    <tr>
