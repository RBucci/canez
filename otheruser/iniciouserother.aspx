<%@ Page Title="" Language="C#" MasterPageFile="~/otheruser/user.Master" AutoEventWireup="true" CodeFile="iniciouserother.aspx.cs" Inherits="CanezPower.otheruser.iniciouserother" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 86%; height: 127px;">
        <tr>
            <td>
                <asp:Button ID="Button3" runat="server" Height="32px" Text="INVENTORY" Width="155px" BackColor="#507CD1" ForeColor="White" OnClick="Button3_Click" Visible="False" />
            </td>
            <td>
                <asp:Button ID="Button4" runat="server" Height="32px" Text="SERVICE" Width="155px" BackColor="#507CD1" ForeColor="White" OnClick="Button4_Click" Visible="False" />
            </td>
            <td>
                <asp:Button ID="Button6" runat="server" Height="32px" Text="SHOP" Width="155px" BackColor="#507CD1" ForeColor="White" OnClick="Button6_Click" Visible="False" />
            </td>
            <td>
                <asp:Button ID="Button8" runat="server" Height="32px" Text="FF-CM" Width="155px" BackColor="#507CD1" ForeColor="White" OnClick="Button8_Click" Visible="False" />
            </td>
            <td style="width: 5px">
                &nbsp;</td>
            <td>
                <asp:Button ID="Button2" runat="server" Height="32px" Text="CM" Width="155px" BackColor="#507CD1" ForeColor="White" OnClick="Button2_Click" Visible="False" />
            </td>
        </tr>
        <tr>
            <td>
                <asp:Button ID="Button11" runat="server" Height="32px" Text="TTN" Width="155px" BackColor="#507CD1" ForeColor="White" OnClick="Button11_Click" Visible="False" />
            </td>
            <td>
                <asp:Button ID="Button9" runat="server" Height="32px" Text="WAREHOUSE" Width="155px" BackColor="#507CD1" ForeColor="White" OnClick="Button9_Click" Visible="False" />
            </td>
            <td>
                <asp:Button ID="Button7" runat="server" Height="32px" Text="PANEL CODES" Width="155px" BackColor="#507CD1" ForeColor="White" OnClick="Button7_Click" Visible="False" />
            </td>
            <td>
                <asp:Button ID="Button5" runat="server" Height="32px" Text="SPENDING TRACK" Width="155px" BackColor="#507CD1" ForeColor="White" OnClick="Button5_Click1" Visible="False" />
            </td>
            <td style="width: 5px">
                &nbsp;</td>
            <td>
                <asp:Button ID="Button10" runat="server" Height="32px" Text="INVOICES TRACK" Width="155px" BackColor="#507CD1" ForeColor="White" OnClick="Button10_Click" Visible="False" />
            </td>
        </tr>
    </table>
    ...
    <table style="width: 322px" >
                    ...
                    <tr>
                        ...
                        <td style="width: 375px">
                            <asp:TextBox ID="CBSITE" runat="server" AutoPostBack="True" Enabled="False" Height="26px" OnTextChanged="CBSITE_TextChanged" Width="144px"></asp:TextBox>
                        </td>
                        <td style="width: 30px">
...
ORDER BY [System ID] DESC"></asp:SqlDataSource>
        ...
        <tr>
            <td colspan="2">
            <asp:GridView ID="GridView3" runat="server" Height="16px"  Width="1099px" CellPadding="4" ForeColor="#333333" CssClass="auto-style25" style="font-size: x-small; text-align: left;" AutoGenerateColumns="False" DataKeyNames="TTN" DataSourceID="SqlDataSource1" OnRowCommand="GridView3_RowCommand" >
