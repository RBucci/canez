...
{
    public partial class gaiaviewuser : System.Web.UI.Page
    {
        ...
        protected void BTNBUSCAR_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string CADENA = string.Format("select * from tbgaia where freetext(*, '" + TXTUSUARIO.Text + "' )order by id desc");
                DataSet DS = CLASS_CONECTAR.CONECTAR(CADENA);
        ...
        void verpdf()
        {
            ...
            System.Data.DataSet DS = CanezPower.CLASS_CONECTAR.CONECTAR(COMANDO12);
