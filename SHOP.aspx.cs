...
namespace CanezPower
{
    public partial class SHOP : System.Web.UI.Page
    {
        ...
        protected void save0_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                for (int i = 0; i < Context.Request.Files.Count; i++)
                {
                    ...
                    string CADENA = string.Format("insert into DOCUMENT_SHOP values('" + id + "','" + GridView1.SelectedRow.Cells[5].Text + "','" + "http://canezpowerdivision.com/canezpdf/" + nombre + "',GETDATE(),'" + GetTime() + "','" + "shop" + "')");
                    DataSet DS = CLASS_CONECTAR.CONECTAR(CADENA);
                }
                Response.Redirect("~/SHOP.aspx");
            }
        ...
        protected void TXTESTATUS_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (TXTESTATUS.Text == "Under Maintenance")
            {

                TXTGENSETSERIAL.DataSource = null;
