...
namespace CanezPower
{
    public partial class INICIO : System.Web.UI.Page
    {
        ...
        protected void BTNBUSCAR_Click(object sender, EventArgs e)
        {
            ...
            if (chetall.Checked == true && CHECKALGENSET.Checked == false)
            {
                try
                {
                    ...
                    string COMANDO7 = string.Format("SELECT DISTINCT       TBLOG.id, Date, Site, TBLOG.Genset, Genset_Serial AS [Genset Serial], Reference, honning_Hours AS [Running Hours], Notas AS [Description],CASE WHEN (DOCUMENT_SHOP.id_genset <> '" + "" + "' AND DOCUMENT_SHOP.tipo = 'log') THEN 'YES' ELSE 'NO' END AS Attachment, User_Login as [User] FROM            edgar2211.TBLOG  LEFT OUTER JOIN DOCUMENT_SHOP on edgar2211.TBLOG.Genset = edgar2211.DOCUMENT_SHOP.GENSET and TBLOG.id = DOCUMENT_SHOP.id_genset     WHERE TBLOG.Site ='" + CBSITE.Text + "' AND TBLOG.Genset='" + CBGENSET.Text + "'   order by TBLOG.id desc");
            ...
            }else if (CHECKALGENSET.Checked == true)
             {
                ...
                {
                    ////BUSQUEDA POR SITE
                    string COMANDO1 = string.Format("SELECT  DISTINCT      edgar2211.technical.ID AS Id, edgar2211.technical.DATE1 AS Date, replace(convert(Varchar ,case when(DATEDIFF(DAY, getdate(), DATE_FINICH)< 1 )then 0 else DATEDIFF(DAY, getdate(), DATE_FINICH)  end),'0','Done')  AS [Next Service],  edgar2211.technical.VERIFICATION AS [Need a Review?], edgar2211.technical.DATE_FINICH, edgar2211.technical.SITE AS Site, edgar2211.technical.GENSET AS Genset, edgar2211.technical.TEAM AS Team, edgar2211.technical.HOUR_MASTER_READING AS [Hour Master Reading], edgar2211.technical.QIL_RUMMING_HR AS [Oil Running Hr], edgar2211.technical.OIL_ENGINE_REPLACE AS [Oil Engine Replace], edgar2211.technical.OIL_QTY_REMOVED AS [Oil Qty Removed], edgar2211.technical.OIL_QTY_GL AS [Oil Qty (gl)], edgar2211.technical.OIL_DIFERENT AS [Oil Different], edgar2211.technical.OIL_FILTER_REPLACE AS [Oil Filter Replace], edgar2211.technical.TANK_DECARTER_FILTER_REPLACE AS [Tank Decarter Filter Replace], edgar2211.technical.PRE_FUEL_FILTER_REPLACE AS [Pre-fuel Filter Replace], edgar2211.technical.FUEL_FILTER_REPLACE AS [Fuel Filter Replace], edgar2211.technical.INNERT_A_IR_FILTER_REPLACE AS [Inner Air Filter Replace], edgar2211.technical.OUTER_AIR_FILTER_CHANGE AS [Outer Air Filter Cheange], edgar2211.technical.NOTA AS Decription,CASE WHEN (DOCUMENT_SHOP.id_genset <> '" + "" + "' AND DOCUMENT_SHOP.tipo = 'service') THEN 'YES' ELSE 'NO' END AS Attachment, edgar2211.technical.USER_LOG AS [User Login]FROM            edgar2211.technical LEFT OUTER JOIN edgar2211.DOCUMENT_SHOP ON edgar2211.technical.Genset = edgar2211.DOCUMENT_SHOP.GENSET and edgar2211.technical.ID = edgar2211.DOCUMENT_SHOP.ID_GENSET      where edgar2211.technical.SITE = '" + CBSITE.Text + "' order by technical.ID desc");
                    DataSet DS1 = CLASS_CONECTAR.CONECTAR(COMANDO1);
                    ...
                    string COMANDO7 = string.Format("SELECT DISTINCT       TBLOG.id, Date, Site, TBLOG.Genset, Genset_Serial AS [Genset Serial], Reference, honning_Hours AS [Running Hours], Notas AS [Description],CASE WHEN (DOCUMENT_SHOP.id_genset <> '" + "" + "' AND DOCUMENT_SHOP.tipo = 'log') THEN 'YES' ELSE 'NO' END AS Attachment, User_Login as [User] FROM            edgar2211.TBLOG  LEFT OUTER JOIN DOCUMENT_SHOP on  edgar2211.TBLOG.Genset = edgar2211.DOCUMENT_SHOP.GENSET and TBLOG.id = DOCUMENT_SHOP.id_genset     WHERE TBLOG.Site ='" + CBSITE.Text + "'  order by TBLOG.id desc");
                    DataSet DS7 = CLASS_CONECTAR.CONECTAR(COMANDO7);
        ...
        protected void BTNBUSCAR0_Click(object sender, EventArgs e)
        {
            if (chekonlydate.Checked == true)
            {
                ...
                try
                {
                    ...
                    string COMANDO45 = string.Format("SELECT  DISTINCT      edgar2211.technical.ID AS Id, edgar2211.technical.DATE1 AS Date, replace(convert(Varchar ,case when(DATEDIFF(DAY, getdate(), DATE_FINICH)< 1 )then 0 else DATEDIFF(DAY, getdate(), DATE_FINICH)  end),'0','Done')  AS [Next Service],  edgar2211.technical.VERIFICATION AS [Need a Review?], edgar2211.technical.DATE_FINICH, edgar2211.technical.SITE AS Site, edgar2211.technical.GENSET AS Genset, edgar2211.technical.TEAM AS Team, edgar2211.technical.HOUR_MASTER_READING AS [Hour Master Reading], edgar2211.technical.QIL_RUMMING_HR AS [Oil Running Hr], edgar2211.technical.OIL_ENGINE_REPLACE AS [Oil Engine Replace], edgar2211.technical.OIL_QTY_REMOVED AS [Oil Qty Removed], edgar2211.technical.OIL_QTY_GL AS [Oil Qty (gl)], edgar2211.technical.OIL_DIFERENT AS [Oil Different], edgar2211.technical.OIL_FILTER_REPLACE AS [Oil Filter Replace], edgar2211.technical.TANK_DECARTER_FILTER_REPLACE AS [Tank Decarter Filter Replace], edgar2211.technical.PRE_FUEL_FILTER_REPLACE AS [Pre-fuel Filter Replace], edgar2211.technical.FUEL_FILTER_REPLACE AS [Fuel Filter Replace], edgar2211.technical.INNERT_A_IR_FILTER_REPLACE AS [Inner Air Filter Replace], edgar2211.technical.OUTER_AIR_FILTER_CHANGE AS [Outer Air Filter Cheange], edgar2211.technical.NOTA AS Decription,CASE WHEN (DOCUMENT_SHOP.id_genset <> '" + "" + "' AND DOCUMENT_SHOP.tipo = 'service') THEN 'YES' ELSE 'NO' END AS Attachment, edgar2211.technical.USER_LOG AS [User Login]FROM            edgar2211.technical LEFT OUTER JOIN edgar2211.DOCUMENT_SHOP ON  edgar2211.technical.Genset = edgar2211.DOCUMENT_SHOP.GENSET and   edgar2211.technical.ID = edgar2211.DOCUMENT_SHOP.ID_GENSET       where (technical.DATE1>='" + TXTDESDE.Text + "') AND (technical.DATE1<='" + TXTHASTA.Text + "')  order by technical.DATE1 desc");
            ...
            else
            {
                ...
                if (CHECKLOG.Checked == true)
                {
                    try
                    {
                        string COMANDO7 = string.Format("SELECT DISTINCT       TBLOG.id, Date, Site, TBLOG.Genset, Genset_Serial AS [Genset Serial], Reference, honning_Hours AS [Running Hours], Notas AS [Description],CASE WHEN (DOCUMENT_SHOP.id_genset <> '" + "" + "' AND DOCUMENT_SHOP.tipo = 'log') THEN 'YES' ELSE 'NO' END AS Attachment, User_Login as [User] FROM            edgar2211.TBLOG  LEFT OUTER JOIN DOCUMENT_SHOP on  edgar2211.TBLOG.Genset = edgar2211.DOCUMENT_SHOP.GENSET and TBLOG.id = DOCUMENT_SHOP.id_genset     WHERE TBGOG.Genset='" + CBGENSET.Text + "' AND(TBLOG.Date>='" + TXTDESDE.Text + "')and(TBLOG.Date<='" + TXTHASTA.Text + "')   order by TBLOG.id desc");
                        DataSet DS7 = CLASS_CONECTAR.CONECTAR(COMANDO7);
        ...
        protected void GridView5_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "btver")
            {
                ...
                try
                {
                    ...
                    Response.Write("<script>window.open('DOCUMENT_SHOP.aspx?ID=" + IDGENSET.ToString() + "&GENSET=" + GENSET.ToString() + "&page=" + "shop" + "')</script>");
        ...
        protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "btver")
            {
                ...
                try
                {
                    ...
                    Response.Write("<script>window.open('DOCUMENT_SHOP.aspx?ID=" + IDGENSET.ToString() + "&GENSET=" + GENSET.ToString() + "&page=" + "CM" + "')</script>");
        ...
        protected void GridView4_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "btver")
            {
                ...
                try
                {
                    ...
                    Response.Write("<script>window.open('DOCUMENT_SHOP.aspx?ID=" + IDGENSET.ToString() + "&GENSET=" + GENSET.ToString() + "&page=" + "FFCM" + "')</script>");
        ...
        protected void GridView3_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "btver")
            {
                ...
                try
                {
                    ...
                    Response.Write("<script>window.open('DOCUMENT_SHOP.aspx?ID=" + IDGENSET.ToString() + "&GENSET=" + GENSET.ToString() + "&page=" + "ttn" + "')</script>");
        ...
        protected void GridView1_RowCommand1(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "btver")
            {
                ...
                try
                {
                    ...
                    Response.Write("<script>window.open('DOCUMENT_SHOP.aspx?ID=" + IDGENSET.ToString() + "&GENSET=" + GENSET.ToString() + "&page=" + "log" + "')</script>");
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "btver")
            {
                ...
                try
                {
                    ...
                    Response.Write("<script>window.open('DOCUMENT_SHOP.aspx?ID=" + IDGENSET.ToString() + "&GENSET=" + GENSET.ToString() + "&page=" + "service"+"')</script>");
        ...
        protected void GridView3_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                if (e.Row.Cells[13].Text.CompareTo("OPEN") == 0)
                {
                    e.Row.BackColor = Color.FromName("#f16059");
                }

                if (e.Row.Cells[13].Text.CompareTo("ON GOING") == 0)
                {
                    e.Row.BackColor = Color.FromName("#ece198");
                }

                if (e.Row.Cells[13].Text.CompareTo("CLOSED") == 0)
                {
