<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GAIA.aspx.cs" Inherits="CanezPower.GAIA" %>
...
document.getElementById(cajadestino).focus(); 
    ...
    <tr>
        ...
        <td style="height: 4px; width: 178px; " class="text-left">
            ...
            <b>
            <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/CATEGORY_GAIA.aspx">ADD NEW CATEGORY</asp:HyperLink>
                </b>
        ...
        <td style="height: 4px; width: 267px">
            ...
            <b>
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/ENERGIE.aspx">NEW ENGINE</asp:HyperLink>
                </b>
    ...
    <asp:TextBox ID="TextBox1" placeholder="Search" runat="server" Visible="false" Height="30px" Width="154px"></asp:TextBox>
                 ...
                 <td>
                     ...
                     <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                         <ContentTemplate>
                              <asp:Button ID="btnbuscar1" runat="server" Text="Search pdf" Visible="false" Width="106px" OnClick="btnbuscar1_Click" />
                         </ContentTemplate>
