<%@ Page Title="" Language="C#" MasterPageFile="~/ValerioCanez/Site.Master" AutoEventWireup="true" Codefile="NewValerioCanez.aspx.cs" Inherits="CanezPower.ValerioCanez.NewValerioCanez" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <BR />
    <table style="width: 99%; height: 944px;">
        <tr>
            <td colspan="5">
        ...
        <tr>
            <td style="text-align: right; width: 162px;"><b>End User:</b></td>
            <td colspan="3">
        ...
        <tr>
            ...
            <td colspan="3" rowspan="2">
                <asp:Label ID="LBLESTADO" runat="server" ></asp:Label>
                    <br />
                <br />
                <asp:Button ID="BTNGUARDAR" runat="server" Text="SAVE AND SEND"   OnClientClick="return confirm('Are you sure you want to save this item?');"     class="btn btn-success" OnClick="BTNGUARDAR_Click" Height="46px" />
                <br />
                <br />
                
                 <asp:Button ID="BTNEDIT" runat="server" Text="EDIT"   OnClientClick="return confirm('Are you sure you want to edit this item?');" class="btn btn-info" OnClick="BTNEDIT_Click" Height="43px"   />
                <br />  
                <br /> <asp:Button ID="BTNDELETE" runat="server" Text="DELETE"  OnClientClick="return confirm('are you sure you want to erase this item?');" class="btn btn-danger"  OnClick="BTNDELETE_Click" Height="46px"  />
            </td>
