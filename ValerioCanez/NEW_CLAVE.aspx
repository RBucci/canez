<%@ Page Title="" Language="C#" MasterPageFile="~/ValerioCanez/Site.Master" AutoEventWireup="true" CodeFile="NEW_CLAVE.aspx.cs" Inherits="CanezPower.ValerioCanez.NEW_CLAVE" %>
    ...
    <table style="width: 90%">
        ...
        <tr>
            ...
            <td style="width: 264px; height: 15px;">
                ...
                <asp:Button ID="BTNEXPO" runat="server" Text="SAVE" OnClientClick="return confirm('Are you sure you want to recieve the password?');"  OnClick="BTNEXPO_Click" class="btn btn-success" />  
