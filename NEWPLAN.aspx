<%@ Page Title="" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeFile="NEWPLAN.aspx.cs" Inherits="CanezPower.NEWPLAN" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="headcontent" runat="server">
    ...
    <table style="width: 84%; height: 505px;">
        ...
        <tr>
            <td>&nbsp;</td>
            <td>
                <asp:Button ID="BTNGUARDAR" runat="server" Text="SAVE AND SEND" Width="91px"  OnClientClick="return confirm('Are you sure you want to save this item?');"    OnClick  ="BTNGUARDAR_Click" style="font-weight: 700; font-size: xx-small;" />
