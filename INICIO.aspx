<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="INICIO.aspx.cs" Inherits="CanezPower.INICIO" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 86%; height: 127px;">
        <tr>
            <td>
                <asp:Button ID="Button3" Text="INVENTORY" runat="server" Width="206px" OnClick="Button3_Click" CssClass="btn btn-success" />
            </td>
            <td>
                <asp:Button ID="Button4" Text="SERVICE" runat="server"  OnClick="Button4_Click" Width="206px" CssClass="btn btn-success" />
            </td>
            <td>
                <asp:Button ID="Button6" TEXT="SHOP" runat="server" OnClick="Button6_Click" Width="206px" CssClass="btn btn-success" />
            </td>
            <td>
                <asp:Button ID="Button8" Text="FF-CM" runat="server" OnClick="Button8_Click" Width="206px" CssClass="btn btn-success" />
            </td>
            <td style="width: 5px">
                &nbsp;</td>
            <td>
                <asp:Button ID="Button2" Text="CM" runat="server"  OnClick="Button2_Click" Width="206px" CssClass="btn btn-success" />
            </td>
        </tr>
        <tr>
            <td>
                <asp:Button ID="Button11" Text="TTN" runat="server"  OnClick="Button11_Click" Width="206px" CssClass="btn btn-success" />
            </td>
            <td>
                <asp:Button ID="Button9" Text="WAHREHOUSE" runat="server"  OnClick="Button9_Click" Width="206px" CssClass="btn btn-success" />
            </td>
            <td>
                <asp:Button ID="Button7" Text="PANEL CODE" runat="server"  OnClick="Button7_Click" Width="206px" CssClass="btn btn-success" />
            </td>
            <td>
                <asp:Button ID="Button5"  Text="EXPENSES TRACK" runat="server"  OnClick="Button5_Click1" CssClass="btn btn-success" Width="206px" />
            </td>
            <td style="width: 5px">
                &nbsp;</td>
            <td>
                <asp:Button ID="Button10" runat="server" Text="INVOICES TRACK"  OnClick="Button10_Click" Width="206px" CssClass="btn btn-success" />
            </td>
        </tr>
    </table>
...
<asp:Content ID="Content2" ContentPlaceHolderID="headcontent" runat="server">
    ...
    <table style="width: 483px" >
                    ...
                    <asp:DropDownList ID="CBSITE" runat="server" Height="26px" style="font-weight: bold" Width="144px" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="CBSITE_SelectedIndexChanged">
                    </asp:DropDownList>
                        </td>
                        <td style="width: 30px">
                        ...
                        <td>
                            ...
                            <b>
                <asp:TextBox ID="TXTDESDE" runat="server" Height="26px" Width="144px" CssClass="form-control" TextMode="Date"></asp:TextBox>
                </b>
                    ...
                    <asp:DropDownList ID="CBGENSET" runat="server" Height="26px" style="font-weight: bold" Width="144px" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="CBGENSET_SelectedIndexChanged">
                    </asp:DropDownList>
                        </td>
                        ...
                        <td style="height: 39px">
                            <b>
                <asp:TextBox ID="TXTHASTA" runat="server" Height="26px" Width="144px" CssClass="form-control" TextMode="Date"></asp:TextBox>
                </b>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 375px; height: 23px;">
                            <asp:CheckBox ID="CHECKALGENSET" runat="server" Text="ALL GENSET" CssClass="form-control" />
                        ...
                        <td style="height: 23px">
                            ...
                            <asp:CheckBox ID="chekonlydate" runat="server" Text=" Search Only Date  " CssClass="form-control" Width="174px" />
                        </td>
               ...
               <asp:Button ID="BTNBUSCAR" runat="server" Text="SEARCH" CssClass="btn btn-success" OnClick="BTNBUSCAR_Click" />
                        ...
                        <td>
                            &nbsp;</td>
                        <td>
               <asp:Button ID="BTNBUSCAR0" runat="server" Text="SEARCH" CssClass="btn btn-success" OnClick="BTNBUSCAR0_Click" />
                        </td>
                        <td style="width: 88px">
                            &nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="4" >
                            ...
                            <asp:Panel ID="Panel1" runat="server" Width="157px">
                                 ...
                                 <asp:Button ID="BTNBUSCAR1" runat="server" Text="EXPORT EXCEL" CssClass="btn btn-success" OnClick="BTNBUSCAR1_Click" />
