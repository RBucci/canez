<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="SEE_TRAINING.aspx.cs" Inherits="CanezPower.SEE_TRAINING" %>
...
function init() {
    ...
    <tr>
        ...
        <td style="height: 31px; width: 267px">
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Training.aspx">NEW TRAINING</asp:HyperLink>
        </td>
