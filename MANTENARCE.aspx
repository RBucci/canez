...
document.getElementById(cajadestino).focus(); 
       ...
       <table class="auto-style50" >
                    ...
                    <asp:Button ID="BTNDELETE" runat="server"  Text="DELETE" Width="91px" CssClass="auto-style25" OnClientClick="return confirm('are you sure you want to erase this item?');" OnClick="BTNDELETE_Click" />
                            </span></span>                
                    </table>
   ...
   <%--    <table style="width: 1909PX; border:0PX; background-color: #507CD1; color:#ffffff">
            <tr>
                <td style="width:30PX">NO.</td>
                <td style="width:10PX"> &nbsp;</td>
                <td style="width:35PX"> ID</td>
                <td style="width:20PX">DATE</td>
                <td style="width:35PX">NEXT SERVICE</td>
                <td style="width:35PX">NEED A REVIEW?</td>
                <td style="width:35PX"> DATE FINICH</td>
                <td style="width:33px"> SITE</td>
                <td style="width:30px">GENSET</td>
                <td style="width:20px">TEAM</td>
                <td style="width:60px">HOUR RUNNING READING</td>
                <td style="width:80px">OIL RUNNING HR</td>
                <td style="width:50px">OIL ENGINE REPLACE</td>
                
                <td style="width:30PX">OIL QTY REMOVED</td>
                <td style="width:30PX">OIL QTY (GL)</td>
                <td style="width:90PX">OIL DIFFERENT</td>
                <td style="width:71px">TANK DECARTE FILTER REPLACE</td>
                <td style="width:30PX">PRE-FUEL FILTER REPLACE</td>
                <td style="width:30PX">FUEL FILTE R REPLACE</td>
                <td style="width:30PX">INNER AIR FILTER REPLACE</td>
                <td style="width:30PX">OUTER AIR FILTER CHANGE</td>
                <td style="width:30PX">DECRITPTION</td>
                <td style="width:30PX">SEE ATTACHMENT</td>
                <td style="width:30PX">ATTACHMENT</td>
                <td style="width:30PX">USER</td>
            </tr>
        </table>
       <div class="scroll" style="width: 1944px; height: 271px">
      ...
      --%>
            <asp:GridView ID="GridView1" runat="server"  Height="16px"  Width="1909px" CellPadding="4" ForeColor="#333333" CssClass="auto-style25" style="font-size: xx-small" Font-Names="Latha" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDataBound="GridView1_RowDataBound1" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" OnRowCommand="GridView1_RowCommand">
                    ...
                    <SortedDescendingHeaderStyle BackColor="#4870BE" />
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Edgarpower_ConnectionString %>" SelectCommand="SELECT    DISTINCT    edgar2211.technical.ID AS Id, edgar2211.technical.DATE1 AS Date, replace(convert(Varchar ,case when(DATEDIFF(DAY, getdate(), DATE_FINICH)< 1 )then 0 else DATEDIFF(DAY, getdate(), DATE_FINICH)  end),'0','Done')  AS [Next Service], 
