<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="ValerioCanezGenset.aspx.cs" Inherits="CanezPower.ValerioCanezGenset" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <table style="width: 65%; height: 209px;">
        <tr>
        ...
        <tr>
            <td style="width: 184px; text-align: center; height: 38px;">
        ...
        <tr>
            <td class="text-center" style="width: 184px; height: 7px; text-align: center; font-weight: bold;">
        ...
        <tr>
            <td class="text-left" style="width: 184px; height: 23px">
            ...
            <td class="text-left" style="width: 185px; height: 23px">
            ...
            <td class="text-left" style="height: 23px; width: 123px;">

                <asp:Button ID="btnbuscar" runat="server"  Text="Search"  class="btn btn-success" OnClick="btnbuscar_Click" />
            ...
            <td class="text-left" style="height: 23px">
                ...
                <asp:HyperLink ID="HyperLink1" runat="server" class="btn btn-success" NavigateUrl="~/NewValerioCanez.aspx" >ADD NEW GENSET</asp:HyperLink>
...
<%--
                ...
                <asp:Button ID="sportexcel" runat="server"  Text="EXPORT EXCEL"  class="btn btn-success" OnClick="sportexcel_Click" />
...
--%>
        ...
        <tr>
            <td class="text-center" style="width: 184px; height: 23px; text-align: center;">
                 ...
                 <asp:GridView ID="GridView1" runat="server" class="table table-bordered"   Width="1208px"   AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataSourceID="SqlDataSource1" >
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <asp:BoundField DataField="End User" HeaderText="End User" SortExpression="End User" />
