<%@ Page Title="" Language="C#" MasterPageFile="~/USUARIO1/Site2.Master" AutoEventWireup="true" CodeFile="CM2.aspx.cs" Inherits="CanezPower.USUARIO1.CM2" %>
...
document.getElementById(cajadestino).focus(); 
    ...
    <table style="width: 49%; height: 177px;">
        ...
        <tr>
            <td  style="width: 100px; ">
                &nbsp;</td>
            <td><asp:Button ID="save" runat="server" Text="SAVE AND SEND"  OnClientClick="return confirm('Are you sure you want to save this item?');" Visible="false"  OnClick="Button3_Click" Width="91px" />
            </td>
            <td>&nbsp;&nbsp;&nbsp;<asp:Button ID="Button4" runat="server" Text="EDIT" OnClientClick="return confirm('Are you sure you want to edit this item?');" Visible="false" OnClick="Button4_Click" Width="91px" />
            </td>
            <td>
                <asp:Button ID="Button5" runat="server" Text="DELETE" OnClientClick="return confirm('Are you sure you want to delete this item?');" Visible="false" OnClick="Button5_Click" Width="91px"  />
            </td>
            <td>&nbsp;</td>
            <td style="text-align: right">&nbsp;</td>
            <td style="text-align: center">
        ...
        <tr>
            <td colspan="4">
                ...
                <asp:GridView ID="GridView1" runat="server" Height="16px"  Width="980px" CellPadding="4" ForeColor="Black" CssClass="auto-style25" style="font-size: x-small; text-align: left;" Font-Names="Latha" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" OnRowCommand="GridView1_RowCommand" >
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Edgarpower_ConnectionString %>" SelectCommand="SELECT   DISTINCT     cm2.id, Date, Site, cm2.Genset, Genset_Serial AS [Genset Serial], Reference, Running_Hours AS [Running Hours], Notas AS [Description],CASE WHEN (DOCUMENT_SHOP.id_genset &lt;&gt; '&quot;+&quot;&quot;+&quot;' AND DOCUMENT_SHOP.tipo = 'CM') THEN '1' ELSE '0' END AS Attachment, User_Login as [User] FROM            edgar2211.cm2  LEFT OUTER JOIN DOCUMENT_SHOP on edgar2211.cm2.GENSET = edgar2211.DOCUMENT_SHOP.GENSET and cm2.id = DOCUMENT_SHOP.id_genset    order by cm2.id desc"></asp:SqlDataSource>
