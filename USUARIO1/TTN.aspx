<%@ Page Title="" Language="C#" MasterPageFile="~/USUARIO1/Site2.Master" AutoEventWireup="true" CodeFile="TTN.aspx.cs" Inherits="CanezPower.USUARIO1.TTN" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 47%; height: 4px;">
        ...
        <tr>
            <td style="width: 144px; font-weight: bold; " class="text-center">SITE</td>
            <td class="text-center" style="width: 72px; font-weight: bold; ">TASK</td>
            <td style="width: 153px; font-weight: bold; " class="text-center">TARGET DATE</td>
        ...
        <tr>
            <td style="width: 144px; font-weight: bold; " class="text-center">GENSET</td>
        ...
        <tr>
            ...
            <td style="width: 153px; text-align: center;">&nbsp;&nbsp;&nbsp;<strong>&nbsp;&nbsp;FEEDBACK DECRIPTION</strong></td>
        ...
        <tr>
            <td rowspan="3" style="width: 144px"><asp:TextBox ID="TXTNOTA" runat="server"  Height="60px" Width="144px" MaxLength="200" TextMode="MultiLine" style="font-size: xx-small" CssClass="FixedHeader"></asp:TextBox>
            </td>
            <td rowspan="3">
        ...
        <tr>
            <td style="width: 153px">
                &nbsp;</td>
            <td class="text-center">
            <asp:Button ID="BTNGUARDAR1" runat="server" Text="DELETE" Width="91px "  OnClientClick="return confirm('Are you sure you want to delete this item?');" Visible="false"  OnClick="DELETE" style="font-size: xx-small" CssClass="FixedHeader" />
            </td>
            <td class="text-center">
                &nbsp;</td>
        </tr>
