<%@ Page Title="" Language="C#" MasterPageFile="~/USUARIO1/Site2.Master" AutoEventWireup="true" CodeFile="FUELUSE.aspx.cs" Inherits="CanezPower.USUARIO1.FUELUSE" %>
...
document.getElementById(cajadestino).focus(); 
    ...
    <asp:Label ID="LBLESTADO1" runat="server"></asp:Label>
        ...
        <tr>
            <td class="text-center" style="width: 121px">
                <asp:Button ID="BTNSAVE" runat="server" Text="SAVE AND SEND" OnClientClick="return confirm('Are you sure you want to save this item?');" Visible="false" OnClick="Button3_Click" Width="91px" CssClass="FixedHeader" />
            </td>
            <td class="text-center">
