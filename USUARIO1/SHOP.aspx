<%@ Page Title="" Language="C#" MasterPageFile="~/USUARIO1/Site2.Master" AutoEventWireup="true" CodeFile="SHOP.aspx.cs" Inherits="CanezPower.USUARIO1.SHOP" %>
...
document.getElementById(cajadestino); 
        ...
        <tr>
            ...
            <td style="height: 21px">
                <asp:DropDownList ID="TXTESTATUS" runat="server" Height="26px" Width="144px">
            ...
            <td style="height: 21px">
                <asp:TextBox ID="TXTREFENCE0" runat="server" Width="144px" Enabled="False" Height="26px"></asp:TextBox>
            </td>
        ...
        <tr>
            ...
            <td>
                &nbsp;</td>
            <td colspan="2" style="text-align: center"><asp:Button ID="save0" runat="server" Text="Upload File" Visible="false"    OnClick="save0_Click" Width="142px" />
                </td>
        </tr>
        <tr>
            <td  style="width: 100px; ">
        ...
        <tr>
            <td  style="width: 100px; ">
                &nbsp;</td>
            <td style="text-align: center">&nbsp;</td>
            <td style="text-align: center"><asp:Button ID="save" runat="server" Text="SAVE AND SEND" Visible="false"    OnClientClick="return confirm('Are you sure you want to save this item?');"   OnClick="Button3_Click" Width="91px" />
                </td>
            <td style="text-align: center">
                <asp:Button ID="Button4" runat="server" Text="EDIT"   OnClientClick="return confirm('Are you sure you want to edit this item?');"  Visible="false"    OnClick="Button4_Click" Width="91px" />
            </td>
            <td style="text-align: center">
                <asp:Button ID="Button5" runat="server" Text="DELETE" OnClientClick="return confirm('are you sure you want to erase this item?');" Visible="false"    OnClick="Button5_Click" Width="91px"  />
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td colspan="4">
                ...
                <asp:GridView ID="GridView1" runat="server" Height="16px"  Width="1163px" CellPadding="4" ForeColor="Black" CssClass="auto-style25" style="font-size: x-small; text-align: left;" Font-Names="Latha" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AutoGenerateColumns="False" DataKeyNames="System ID" DataSourceID="SqlDataSource1" OnRowCommand="GridView1_RowCommand" OnRowUpdating="GridView1_RowUpdating" >
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Edgarpower_ConnectionString %>" SelectCommand="SELECT DISTINCT 
                         ...
                         THEN '1' ELSE '0' END AS Attachment, edgar2211.Shop.Description, edgar2211.Shop.User_Login AS [User]
FROM            edgar2211.gensetfinal INNER JOIN
