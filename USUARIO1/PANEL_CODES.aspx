<%@ Page Title="" Language="C#" MasterPageFile="~/USUARIO1/Site2.Master" AutoEventWireup="true" CodeFile="PANEL_CODES.aspx.cs" Inherits="CanezPower.USUARIO1.PANEL_CODES" %>
...
document.getElementById(cajadestino).focus(); 
    ...
    <tr>
        ...
        <td class="right" style="font-weight: bold; width: 178px; color: #000000; text-align: right; height: 31px;">
            <asp:Button ID="BTNGUARDAR" runat="server" Text="SAVE AND SEND" OnClientClick="return confirm('Are you sure you want to save this item?');" Visible="false" Width="91px" OnClick="BTNGUARDAR_Click1" style="font-size: xx-small"  />
        </td>
        <td style="width: 154px; height: 31px; text-align: right;">
            <span style="font-size: xx-small"></span>
            <asp:Button ID="BTNEDIT" runat="server" OnClientClick="return confirm('Are you sure you want to edit this item?');" Visible="false" Text="EDIT" Width="91px" OnClick="TXTEDIT_Click" style="font-size: xx-small"  />
        </td>
