<%@ Page Title="" Language="C#" MasterPageFile="~/USUARIO1/Site2.Master" AutoEventWireup="true" CodeFile="STOCKENTER.aspx.cs" Inherits="CanezPower.USUARIO1.STOCKENTER" %>
...
document.getElementById(cajadestino).focus(); 
    ...
    <table style="width: 49%">
        ...
        <tr>
            <td class="text-center" style="width: 121px">
                <asp:Button ID="BTNSAVE" runat="server" Text="SAVE AND SEND" Visible="false" OnClick="Button3_Click" Width="91px" CssClass="FixedHeader" />
            </td>
            <td class="text-center">
