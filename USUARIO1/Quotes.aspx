<%@ Page Title="" Language="C#" MasterPageFile="~/USUARIO1/Site2.Master" AutoEventWireup="true" CodeFile="Quotes.aspx.cs" Inherits="CanezPower.USUARIO1.Quotes" %>
...
document.getElementById(cajadestino).focus(); 
    ...
    <tr>
        <td class="right" style="font-weight: bold; width: 200px; color: #000000; text-align: right; height: 33px; font-size: xx-small;">Quostes #:</td>
       <td style="height: 4px; width: 178px; " class="text-left">
    ...
    <tr>
        ...
        <td class="right" style="font-weight: bold; color: #000000; text-align: left; " colspan="3" rowspan="2">
            <asp:TextBox ID="TXTDESCRIPTION" runat="server" Width="401px"  MaxLength="200" TextMode="MultiLine" style="font-size: xx-small" Height="60px"></asp:TextBox>
        </td>
    ...
    <tr>
        ...
        <td class="right" style="font-weight: bold; width: 178px; color: #000000; text-align: right; height: 31px;">
            <asp:Button ID="BTNGUARDAR" runat="server" Text="SAVE AND SEND" Width="91px" OnClientClick="return confirm('Are you sure you want to save this item?');"  OnClick ="BTNGUARDAR_Click1" Visible="false" style="font-size: xx-small" Height="23px"  />
        </td>
        <td style="width: 154px; height: 31px; text-align: right;">
            <span style="font-size: xx-small"></span>
            <asp:Button ID="TXTEDIT" runat="server"  OnClientClick="return confirm('Are you sure you want to edit this item?');"  Text="EDIT" Width="91px" OnClick="TXTEDIT_Click" Visible="false" style="font-size: xx-small" Height="23px"  />
        </td>
        <td style="width: 267px; height: 31px;">
            </span>
            <asp:Button ID="TXTDELETE" runat="server"  OnClientClick="return confirm('Are you sure you want to delete this item?');" Text="DELETE" Width="91px" Visible="false" OnClick="TXTDELETE_Click" style="font-size: xx-small" Height="23px"  />
        </td>
        <td style="width: 267px; height: 31px;">
            &nbsp;</td>
        <td style="width: 267px; height: 31px;">
    ...
    <div>
                ...
                <asp:GridView ID="GridView1" runat="server" Height="16px"  Width="980px" CellPadding="4" ForeColor="Black" CssClass="auto-style25" style="font-size: x-small" Font-Names="Latha" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" OnRowCommand="GridView1_RowCommand" >
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Edgarpower_ConnectionString %>" SelectCommand=" SELECT        ID, DATE, CLIENT, INV, DESCRIPTION,'$'+TOTAL as [Total],DOCUMENT, USER1  FROM            edgar2211.quostes ORDER BY ID DESC"></asp:SqlDataSource>
