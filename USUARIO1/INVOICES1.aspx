<%@ Page Title="" Language="C#" MasterPageFile="~/USUARIO1/Site2.Master" AutoEventWireup="true" CodeFile="INVOICES1.aspx.cs" Inherits="CanezPower.USUARIO1.INVOICES1" %>
   ...
   <script>
    ...
    <tr>
        ...
        <td style="width: 154px; height: 31px; text-align: right;">
            ...
            <asp:Button ID="TXTEDIT" runat="server"  OnClientClick="return confirm('Are you sure you want to edit this item?');" Visible="false"  Text="EDIT" Width="91px" OnClick="TXTEDIT_Click" style="font-size: xx-small" Height="23px"  />
        </td>
        <td style="width: 267px; height: 31px;">
