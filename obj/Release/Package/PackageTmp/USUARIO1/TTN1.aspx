<%@ Page Title="" Language="C#" MasterPageFile="~/USUARIO1/Site1.Master" AutoEventWireup="true" CodeBehind="TTN1.aspx.cs" Inherits="CanezPower.USUARIO1.TTN1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 77%">
        ...
        <tr>
            ...
            <td style="width: 123px">
            <asp:Button ID="BTNGUARDAR" runat="server" Text="SAVE" Width="95px" OnClick="BTNGUARDAR_Click" style="font-size: xx-small" Visible="False" />
            </td>
        ...
        <tr>
            <td style="width: 123px">
            <asp:Button ID="BTNGUARDAR0" runat="server" Text="EDIT" Width="95px" style="font-size: xx-small" OnClick="EDIT" Visible="False" />
            </td>
            <td style="width: 106px">
                &nbsp;</td>
            <td class="text-left">
        ...
        <tr>
            <td style="width: 123px">
            <asp:Button ID="BTNGUARDAR1" runat="server" Text="DELETE" Width="95px" OnClick="DELETE" style="font-size: xx-small" Visible="False" />
            </td>
            <td style="width: 106px">&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
