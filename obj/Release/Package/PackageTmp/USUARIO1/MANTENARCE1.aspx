<%@ Page Title="" Language="C#" MasterPageFile="~/USUARIO1/Site1.Master" AutoEventWireup="true" CodeFile="MANTENARCE1.aspx.cs" Inherits="CanezPower.USUARIO1.MANTENARCE1" %>
        ...
        <tr>
            <td style="width: 264px; height: 21px;"><span style="color: #000000"><span class="auto-style25">
                ...
                <table class="auto-style50" align="center">
                    ...
                    <asp:Button ID="BTNSAVE" runat="server" Height="28px" OnClick="BTNSAVE_Click" Text="SAVE" Width="97px" CssClass="auto-style25" Visible="False" />
                        </td>
                        <td class="auto-style51">
                            <span style="color: #000000"><span class="auto-style25">
                    <asp:Button ID="BTNEDIT" runat="server" Height="28px"  Text="EDIT" Width="97px" CssClass="auto-style25" OnClick="BTNEDIT_Click" Visible="False" />
                            </span></span>
                        </td>
