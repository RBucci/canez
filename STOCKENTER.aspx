<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="STOCKENTER.aspx.cs" Inherits="CanezPower.STOCKENTER" %>
...
document.getElementById(cajadestino).focus(); 
    ...
    <table style="width: 20%; height: 9px;">
        ...
        <tr>
            <td class="text-center" style="font-weight: bold; width: 205px; text-align: center;">TOTAL: <asp:Label ID="LBLESTADO1" runat="server" style="color: #0066FF; text-decoration: underline"></asp:Label>
