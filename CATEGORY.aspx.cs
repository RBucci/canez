    ...
    public partial class CATEGORY : System.Web.UI.Page
    {
        ...
        void NEW_site()
        {
            try
            {
                ...
                string COMANDO = string.Format("INSERT INTO CATEGORY  VALUES('" + TextBox1.Text + "')");
        ...
        void ver_NEW_site_()
        {
            try
            {
                    string COMANDO = string.Format("select * from CATEGORY ORDER BY ID DESC");
                    DataSet DS = CLASS_CONECTAR.CONECTAR(COMANDO);
        ...
        protected void BTNEXPO_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string coman = string.Format("select * from CATEGORY where CATEGORY = '" + TextBox1.Text + "' ");
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                string CADENA = string.Format("select  * FROM CATEGORY WHERE ID='" + comando + "'");
        ...
        protected void BTNEDIT_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string CADENA23 = string.Format("select  * FROM CATEGORY WHERE CATEGORY = '" + TextBox2.Text + "'");
                    ...
                    {
                        //comando = GridView1.SelectedRow.Cells[2].Text;
                        string CADENA = string.Format("update CATEGORY set CATEGORY='" + TextBox1.Text + "' WHERE CATEGORY = '" + CON + "'");
                        DataSet DS = CLASS_CONECTAR.CONECTAR(CADENA);
        ...
        protected void BTNDELETE_Click(object sender, EventArgs e)
        {
            ...
            {
                //comando = GridView1.SelectedRow.Cells[2].Text;
                string CADENA = string.Format("delete from CATEGORY WHERE ID ='" + comando + "'");
                DataSet DS = CLASS_CONECTAR.CONECTAR(CADENA);
                ver_NEW_site_();
                LBLESTADO.Text = "SE REALIZO CORRECTAMENTE";
                Response.Redirect("~/CATEGORY.aspx");
        ...
        protected void btnbuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string COMANDO = string.Format("select * from CATEGORY where CATEGORY like'%" + TextBox1.Text + "%'  ORDER BY id asc");
                DataSet DS = CLASS_CONECTAR.CONECTAR(COMANDO);
                if (DS.Tables[0].Rows.Count <= 0)
                {
